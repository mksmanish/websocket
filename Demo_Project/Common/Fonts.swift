...
class ClassTextFieldSizeClass: UITextField {
    ...
    override func awakeFromNib() {
        ...
        case .iPhone6, .iPhone6S, .iPhone7, .iPhone8:
            self.font = self.font?.withSize((self.font?.pointSize ?? 0) + 2)
        case .iPhone6plus, .iPhone6Splus, .iPhone7plus, .iPhone8plus:
            self.font = self.font?.withSize((self.font?.pointSize ?? 0) + 2)
        case .iPhoneX, .iPhoneXR, .iPhoneXS, .iPhoneXSMax, .iPhone11, .iPhone11Pro, .iPhone11ProMax:
            self.font = self.font?.withSize((self.font?.pointSize ?? 0) + 3)
        default:
            self.font = self.font?.withSize((self.font?.pointSize ?? 0) + 4)
        }
    }
}
...
class ClassButtonSizeClass: UIButton {
    ...
    override func awakeFromNib() {
        ...
        case .iPhone6plus, .iPhone6Splus, .iPhone7plus, .iPhone8plus:
            self.titleLabel?.font = self.titleLabel?.font.withSize((self.titleLabel?.font.pointSize ?? 0) + 2)
        case .iPhoneX, .iPhoneXR, .iPhoneXS, .iPhoneXSMax, .iPhone11, .iPhone11Pro, .iPhone11ProMax:
            self.titleLabel?.font = self.titleLabel?.font.withSize((self.titleLabel?.font.pointSize ?? 0) + 3)
        default:
            self.titleLabel?.font = self.titleLabel?.font.withSize((self.titleLabel?.font.pointSize ?? 0) + 4)
        }
    }
}
